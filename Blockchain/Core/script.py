...
"""
from Blockchain.Core.util.util import int_to_little_endian, encode_varint, little_endian_to_int, read_varint
from Blockchain.Core.EllepticCurve.op import OP_CODE_FUNCTION
